...
@section('filters')
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            {{ Form::select('companies', ['empty' => 'Все компании'] + $companies , $valComp, ['class' => 'form-control'])}}
        </div>
        <div class="col-sm-4">
            Ценовой Диапозон (Руб.)
            <div class="numbers">
            {{ Form::number('from', $valFrom, ['class' => 'form-control']) }}
            </div>
            <div class="numbers">
            {{ Form::number('to', $valTo, ['class' => 'form-control']) }}
            </div>
        </div>
            ...
            <div class="col-sm-4">
                <div class="panel panel-default">
                    <div class="panel-head">
                        <h4>{{$device->name.' '.$device->model_name}}</h4>
                    </div>
